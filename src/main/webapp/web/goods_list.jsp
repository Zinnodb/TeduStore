			...
			<section id="section">
				...
				<div id="wrap">
					<c:forEach var="goods" items="${goodsList }">
						<div class="lf" id="d1">
							<div class="img">
								<a href="details.do?id=${goods.id }"><img src="${pageContext.request.contextPath }${goods.image}"
									alt="" onclick="toItemInfo('${goods.title}')"
									style="width: 230px; height: 260px; margin: 8px;" /></a>
							</div>
							<div class="describe">
