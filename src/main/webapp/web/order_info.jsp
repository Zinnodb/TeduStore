		...
		<div class="adress_choice">
			...
			<div id="addresId1" class="base_select">
				<c:forEach var="address" items="${addresses }">
				 <i class="address_name"> ${address.recvName}  </i> <i class="user_address"> ${address.recvDistrict }, ${address.recvAddress }
					${address.recvPhone}
				 </i> <i class="user_site rt"> 设为默认地址 </i> 
				</c:forEach>
			</div>
		</div>
		<!-- 商品信息-->
				...
				<c:forEach var="cart" items="${carts }">
					<ul class="item_detail">
						<li class="p_info"><b><img
								src="../images/orderConfirm/product_simg1.png" /></b> <b
							class="product_name lf"> ${cart.goodsTitle }</b>
							 <br /> <span class="product_color ">
								颜色：深空灰 </span></li>
						<li class="p_price"><i>达内专属价</i> <br /> <span
							class="pro_price">￥<span class="ppp_price">${cart.goodsPrice }.00</span></span>
						</li>
