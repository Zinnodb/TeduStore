	...
	<header id="top" class="fixed_nav">
		...
		<div class="rt">
			<ul class="lf">
				...
				<li><a href="orders.html" title="我的订单"><img class="order"
				...
				<div id="box">
							...
							<div class="imfor">
								<div class="check">
									<div class="Each">
										...
										</span> <input type="hidden" name="cart_id" value="${cart.id }">
									</div>
								</div>
								<div class="pudc">
									<div class="pudc_information" id="pudcId3">
										<img src="..${cart.goodsImage }" width="84px" height="84px" class="lf" /> <input
											type="hidden" name="" value=""> 
											<span class="des lf">
											${cart.goodsTitle }<input
											type="hidden" name="" value="">
										</span>
										<p class="col lf">
								...
								<div class="pices">
									...
									<p class="pices_information">
										<b>￥</b><span>${cart.goodsPrice }.00 <input type="hidden" name=""
											value=""></span>
									</p>
								</div>
								<div class="num">
								...
								<div class="totle">
									<span>￥</span> <span class="totle_information">${cart.goodsPrice * cart.goodsNum }.00</span>
								</div>
								<div class="del">

									<a href="javascript:;" class="del_yr">移入收藏夹</a> --> <a
										href="javascript:;" class="del_d">删除</a>
								</div>
							</div>
						</c:forEach>
					...
					<div class="foot">
						...
						<div class="foot_cash" id="go-buy">
							<input class="foot_cash" id="go-buy" type="submit" value="去结算"/>
						</div>
						<div class="foot_tol">
