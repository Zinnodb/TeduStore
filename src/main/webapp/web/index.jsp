    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
                <p>电脑整机</p>
                <ul>
                	<c:forEach 	var="goodsCategory"	items="${goodsCategoriesList[0]}">
                    	<li><a href="${pageContext.request.contextPath }/goods/list.do?categoryId=${goodsCategory.id}">${goodsCategory.name }</a></li>
                	</c:forEach>
                </ul>
                <p>电脑配件</p>
                <ul>
                    <c:forEach 	var="goodsCategory"	items="${goodsCategoriesList[1]}">
                    	<li><a href="${pageContext.request.contextPath }/goods/list.do?categoryId=${goodsCategory.id}">${goodsCategory.name }</a></li>
                	</c:forEach>
                </ul>
                <p>外设/游戏</p>
                <ul>
                    <c:forEach 	var="goodsCategory"	items="${goodsCategoriesList[2]}">
                    	<li><a href="${pageContext.request.contextPath }/goods/list.do?categoryId=${goodsCategory.id}">${goodsCategory.name }</a></li>
                	</c:forEach>
                </ul>
            </div>
        ...
        <c:forEach var="good" items="${goods}">
        	<div class="item_msg lf">
            	...
            	<p class="bottom_ys3">￥${good.price}.00</p>

            	<p class="bottom_ys4 color_2"><a href="product_details.html?id=${good.id }">查看详情</a></p>
        	</div>
        </c:forEach>
